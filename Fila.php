...
class Fila
{
	...
	public function setCelda          ( $pobCelda = NULL    ){ $this->layCeldas[]      = $pobCelda; }
	...
	public function setCeldas         ( $payValor = array() ){ $this->layCeldas        = $payValor; }
	...
	public function getCeldar          (){ return $this->layCeldas                ; }
	public function getAttributesAdd   (){ return $this->layAttributesAdd         ; }
	public function getEvent           (){ return $this->layEvent                 ; }
	public function getLengthCeldas    (){ return count( $this->layCeldas )       ; }
